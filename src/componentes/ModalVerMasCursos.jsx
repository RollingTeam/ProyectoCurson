                ...
                <div className="modal-dialog modal-dialog-scrollable">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer justify-content-center">
                            <button type="button" className="btn btn-danger" data-dismiss="modal" onClick={props.handleCloseModal}>Inscribirse</button>
                            <button type="button" className="btn btn-danger">Agregar a mis favoritos</button>
                        </div>
                    </div>
                </div>
            </div>
